...
//    println(names)
//
//    val data1 = mutableListOf("Sonam", "Rahul", "Sumit", 100, 'M', "Sonam")
//    println(data1)
//    println(data1[0])
//    println(data1[1])
//    println(data1[2])
...
//    println(data1)
//
//    data1.add(6, "Jack")         // Add
//    println(data1)
//
//    println(data1.size)
//
//    data1.removeAt(1)        // Remove
//    println(data1)
//    println(data1.size)
//
//    val names1 = mutableListOf<String>("Sonam", "Rahul", "Sumit", "Sonam")
//    println(names1)
//}
...
//    println(names)
//
//    val data1 = mutableSetOf("Sonam", "Rahul", "Sumit", 100, 'M', "Sonam", "Rahul")
//    println(data1)
//    for (dt in data1){
//        println(dt)
//    }
...
//    println(data)
//
//    val names1 = mutableSetOf<String>("Sonam", "Rahul", "Sumit", "Sonam", "Rahul")
//    println(names1)
//}
...
//    println(names)
//
//    val data1 = mutableMapOf(1 to "Sonam", "key2" to "Sumit", "key3" to "Rahul", "key4" to 100)
//    println(data1)
//    println(data1[1])
//    println(data1["key2"])
//    println(data1["key3"])
...
//        println("$key = ${data1[key]}")
//    }
//
//    println(data1.size)
//
//    val names1 = mutableMapOf<String, String>("key1" to "Sonam", "key2" to "Sumit", "key3" to "Rahul", "key4" to
//            "Sameer")
//    println(names1)
//    names1["key2"] = "Jay"       // Update
//    println(names1)
//
//    names1["key5"] = "Sonal"     // Add
//    println(names1)
//
//    names1.put("key3", "Kunal")      // Update
//    println(names1)
//
//    names1.remove("key1")            // Remove
//    println(names1)
//
//    names1.keys.remove("key1")       // Remove
//    println(names1)
//
//    names1.values.remove("Sameer")       // Remove
//    println(names1)
//}